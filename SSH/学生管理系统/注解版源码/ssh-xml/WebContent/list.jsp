    ...
    <table border="1" cellspacing="0" align="center" width="800px">
        ...
        <s:iterator value="studentList">
	        <tr>
	            ...
	            <td>
	                <a href="${pageContext.request.contextPath }/student/stu_toupdate.action?student.id=${id}">修改</a>
	                <a href="#">删除</a>
	            </td>
	        </tr>
        </s:iterator>
...
<script type="text/javascript">
	...
	function toadd(){
		location.href= "${pageContext.request.contextPath }/student/stu_toadd.action";
	}
</script>
</html>